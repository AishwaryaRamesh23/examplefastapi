...
#SQLALCHEMY_DATABASE_URL='postgresql://postgres:postgrespostgres@localhost:5432/fastapi_test'
...
def test_user(client):
    user_data={"email":"shravan@gmail.com",
               "e_password":"shravan7"}
    res=client.post("/users/",json=user_data)
    assert res.status_code==201
    print(res.json())
    new_user=res.json()
    new_user['e_password']=user_data['e_password']
    return new_user

@pytest.fixture
def test_user2(client):
    user_data={"email":"shravanreddy@gmail.com",
               "e_password":"shravan7"}
    res=client.post("/users/",json=user_data)
    assert res.status_code==201
    print(res.json())
...
def test_posts(test_user,session,test_user2):
    posts_data=[{
        ...
        "title":"4td title-reddy",
        "content":"4th content-reddy",
